$(document).ready(function () {
    ...
    for (var j = 0; j < data.length; j++) {
        ...
        if (data[j].status == false) {
            ...
            $('table').append("<tr id=\"r" + j + "\"><td><input type='checkbox' checked></td><td class=\"etitable\" id=\"i" + j + "title\">" + data[j].title + "</td><td class=\"etitable\" id=\"i" + j + "author\">" + data[j].author + "</td><td>" + dd + "-" + mm + "-" + yy + " " + hh + ":" + min + "</td><td><div class=\"delete\">Удалить</div></td></tr>");
        }
    ...
    $('#button_add').click(function (event) {
        ...
        if (($('input[name="author"]').val().length != 0) && ($('input[name="title"]').val().length != 0)) {
            ...
            $('table').append("<tr id=\"r" + (data.length-1) + "\"><td><input type='checkbox'></td><td class=\"etitable\" id=\"i" + (data.length-1) + "title\">" + data[data.length-1].title + "</td><td class=\"etitable\" id=\"i" + (data.length-1) + "author\">" + data[data.length-1].author + "</td><td>" + dd + "-" + mm + "-" + yy + " " + hh + ":" + min + "</td><td><div class=\"delete\">Удалить</div></td></tr>");
            } else { 
                $('table').append("<tr id=\"r" + (data.length-1) + "\"><td><input type='checkbox' checked></td><td class=\"etitable\" id=\"i" + (data.length-1) + "title\">" + data[data.length-1].title + "</td><td class=\"etitable\" id=\"i" + (data.length-1) + "author\">" + data[data.length-1].author + "</td><td>" + dd + "-" + mm + "-" + yy + " " + hh + ":" + min + "</td><td><div class=\"delete\">Удалить</div></td></tr>");
            }
        }
    });
    $(function()	{
